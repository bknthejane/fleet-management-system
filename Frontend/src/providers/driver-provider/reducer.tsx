...
export const DriverReducer = handleActions<IDriverStateContext, IDriverStateContext>(
    {
        [DriverActionEnums.getDriverListPending]: (state, action) => ({
            ...state,
            ...action.payload,
        }),
        [DriverActionEnums.getDriverListSuccess]: (state, action) => ({
            ...state,
            ...action.payload,
        }),
        [DriverActionEnums.getDriverListError]: (state, action) => ({
            ...state,
            ...action.payload,
        }),
