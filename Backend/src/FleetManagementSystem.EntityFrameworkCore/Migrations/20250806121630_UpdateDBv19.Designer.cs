...
namespace FleetManagementSystem.Migrations
{
    ...
    [Migration("20250806121630_UpdateDBv19")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetManagementSystem.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.Incidents.Incident", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.JobCards.JobCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.Municipalities.Municipality", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FleetManagementSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FleetManagementSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FleetManagementSystem.Authorization.Roles.Role", b =>
                {
                    b.HasOne("FleetManagementSystem.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("FleetManagementSystem.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("FleetManagementSystem.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.Incidents.Incident", b =>
                {
                    b.HasOne("FleetManagementSystem.Domain.Drivers.Driver", "Driver")
                        .WithMany()
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.JobCards.JobCard", b =>
                {
                    b.HasOne("FleetManagementSystem.Domain.Mechanics.Mechanic", "AssignedMechanic")
                        .WithMany()
                    ...
                    b.HasOne("FleetManagementSystem.Domain.Incidents.Incident", "Incident")
                        .WithMany()
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.Mechanics.Mechanic", b =>
                {
                    b.HasOne("FleetManagementSystem.Domain.JobCards.JobCard", "AssignedJobCard")
                        .WithMany()
                        .HasForeignKey("AssignedJobCardId");
            ...
            modelBuilder.Entity("FleetManagementSystem.Domain.Supervisors.Supervisor", b =>
                {
                    b.HasOne("FleetManagementSystem.Domain.JobCards.JobCard", "JobCard")
                        .WithOne()
                        .HasForeignKey("FleetManagementSystem.Domain.Supervisors.Supervisor", "AssignedJobCardId");
                    ...
                    b.HasOne("FleetManagementSystem.Authorization.Users.User", "User")
                        .WithOne("Supervisor")
                        .HasForeignKey("FleetManagementSystem.Domain.Supervisors.Supervisor", "UserId");
